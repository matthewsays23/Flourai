...
module.exports = {
  ...
  async execute(interaction) {
    ...
    const embed = new EmbedBuilder()
      .setColor("#302c34")
      .setTitle("<:brownflower:1067479519205789757> Ready to change the status?")
      .setDescription("Select a status type below and let our assistant finish the rest. Be prepared to write a message!")
