...
module.exports = {
  ...
  async execute(interaction) {
    ...
    const embed = new EmbedBuilder()
      ...
      .setDescription(
        [
          "Connect your Roblox account to Discord to receive your verified server identity.",
          "",
          "Verification can update your nickname and assign roles based on your Flourai Roblox group rank.",
          "",
